...
*/
		...
		birthYears.putIfAbsent("Alexei Rykov",1881);

		System.out.println("\"birthYears\" after putIfAbsent method: " + birthYears + "\n");
	}
}
...
"birthYears" after putIfAbsent method: {Josef Stalin=1878, Leonid Brezhnev=1906, Mikhail Gorbachev=1931, Konstantin Chernenko=1911, Nikita Khrushchev=1894, Yuri Andropov=1914, Vladimir Lenin=1870, Alexei Rykov=1881}
